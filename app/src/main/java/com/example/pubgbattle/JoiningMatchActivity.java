...
public class JoiningMatchActivity extends AppCompatActivity {
    ...
    private void CheckIfFull(int occupiedSpot, int totalSpot) {
        if(!validateOccupiedSpot(occupiedSpot, totalSpot)){
    ...
    private boolean validateOccupiedSpot(int occupiedSpot, int totalSpot) {
    ...
    private void SendUserDataToMatches() {
        ...
        myRefOccupiedSpot.runTransaction(new Transaction.Handler() {
            ...
            public void onComplete(@Nullable DatabaseError databaseError, boolean b, @Nullable DataSnapshot dataSnapshot) {
                ...
                ShowNotification();
                UpdateTransactionForMatchJoining(myRefmatchTrans, myRefTrans);
            }
        });
        //**************************************************************************************************************************
    ...
    private void UpdateTransactionForMatchJoining(DatabaseReference myRefmatchTrans, DatabaseReference myRefTrans) {
        myRefmatchTrans.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                final TransactionDetail transactionDetail = new TransactionDetail(transId,
                        "DEBIT", title+" | Joined Successfully", transDate, transTime, amount, txnInt);
    ...
    private void RetrieveUserData() {
        ...
        myRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                totalspot = matchDetail.getMatchTotalSpot();
                entryfee = matchDetail.getMatchEntryFee();
                title = matchDetail.getMatchTitle();
                tv_entryfee.setText(""+ entryfee);
                CheckIfFull(occupiedSpot, totalspot);
                ...
                myRef1.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        CheckForEnoughCoin(currentbalance, entryfee);
    ...
    private void CheckForEnoughCoin(int currentbalance, int entryfee) {
